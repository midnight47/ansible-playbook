...
перед началом нужно объеденить архивы для java jdk

я разделил файл вот такой командой:
split -b 45M jdk-8u371-linux-x64.tar.gz jdk-8u371-linux-x64.tar.gz.part_
нужно их объеденить, поэтому в директории /etc/ansible/roles/nexus/files запускаем команду:
