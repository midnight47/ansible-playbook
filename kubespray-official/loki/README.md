...
5. helm upgrade --install loki grafana/loki --namespace loki --version 6.30.1 -f loki.yaml
...
6. теперь ставим сборщик логов promtail:
    ...
    helm upgrade --install promtail grafana/promtail --namespace loki --version 6.16.6 --values promtail.yaml  
